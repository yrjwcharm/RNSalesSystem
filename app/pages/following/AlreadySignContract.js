...
import {Share,ScrollView,Linking,SafeAreaView,StyleSheet,DeviceEventEmitter,Image,FlatList,Platform,BackHandler,View,Text,TextInput,Alert,ImageBackground,TouchableOpacity} from 'react-native'
...
export default class AlreadySignContract extends PureComponent {
    // 默认属性
    // 构造
    constructor(props) {
        super(props);
