...
export default class AddSalesChance extends PureComponent {
    ...
    _getSalesDetail=()=>{
        ...
        let url=Config.requestUrl+Config.salesChanceDetailPageInterface.singleSalesChanceDetail+`?id=${params.contractId}`
        fetch(url,{method:'POST'}).then(res=>res.json()).then(responseText=>{
            ...
            if(responseText.success){
                ...
                this.setState({remark,status,systemRequirementsName:systemRequirementsName,id,createStr:createtime,priceRange:budgetQuotedRangeStr,sixtyDayPossibilityStr:sixtyDayPossibilityStr});
            }
            this._getPriceRange();
        }).catch(error=>{
            Toast.fail(error)
            ...
            <SafeAreaView style={{flex:1,backgroundColor:'#f2f2f2'}}>
                ...
                <View style={{marginTop:moderateScale(15),paddingHorizontal:moderateScale(13),flex:1}}>
                    <View style={{borderRadius: scale(5),
                        ...
                        shadowOpacity: 1,}}>
                        <DefaultInput1 placeholder={'请输入报价范围'} title={'报价范围'} value={priceRange} noBorder   onChangeText={(priceRange)=>{
                        ...
                        <DefaultInput1 placeholder={'请输入签约可能性'} title={'签约可能性'} value={sixtyDayPossibilityStr} noBorder onChangeText={(sixtyDayPossibilityStr)=>{
                        ...
                        <DefaultInput1  title={'系统类型'}  placeholder={'请选择系统类型'} value={systemRequirementsName} noBorder onChangeText={(systemRequirementsName)=>{
                        ...
                        <DefaultInput placeholder={'请输入需求描述'} title={'需求描述'} value={remark} noBorder onChangeText={(remark)=>{
