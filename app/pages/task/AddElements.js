    ...
    render() {
        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: '#f2f2f2'}}>
                <Title title={'添加要素'} back onPressBack={() => this.props.navigation.goBack()}
                       />
                <View style={{
                    marginTop: px2dp(20),
                ...
                <ListRow style={{
                    ...
                    marginTop: px2dp(26)
                }} value={existOrNoContractId} title={'有无合同'}  onSelected={(item)=>{
                ...
                }} style={{backgroundColor: '#fff', borderBottomWidth: px2dp(1), borderBottomColor: '#E0E0E0'}}
                      title={'索要发票'} />
                <Menu arrow style={{backgroundColor: '#fff'}} title={'系统类型'} detail={systemRequirementsName}
